...
export const strings = {
  ...
  modes: {
    title: "Style & Modes",
    description: "Configure how Ghosty improves your input.",
    newMode: "New Mode",
    import: "Import",
    builtIn: "Built-in",
    custom: "Custom",
    ...
    selectOrCreate: "Select a mode or create a new one.",
    builtInList: "Built-in: Direct, Shape, Reframe, Build.",
    directModeTooltip: "Your words, light formatting only.",
    builtInTooltip: "Built-in (cannot be deleted)",
