    ...
    >
      <div className="space-y-0">
        <p className={cn(uiClasses.sectionLabel, "mb-3")}>
          {strings.settings.system.behavior}
        </p>
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-sm font-medium text-black dark:text-white">
                  {strings.settings.system.services.label}
                </p>
              ...
              <div className="flex flex-col items-end gap-2 shrink-0">
                <button
                  ...
                  className={cn(uiClasses.buttonGhost, "text-xs px-3 py-1.5 disabled:opacity-50")}
                >
                  {installButtonLabel}
                </button>
                <button
                  ...
                  className={cn(uiClasses.buttonGhost, "text-xs underline")}
                >
